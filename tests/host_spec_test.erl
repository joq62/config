...
item()->
    ...
    "192.168.1.100"=config:host_local_ip("c100"),
    "joqhome.asuscomm.com"=host_spec:item(public_ip,"c100"),
    22=config:host_ssh_port("c100"),
    "joq62"=config:host_uid("c100"),
    "festum01"=config:host_passwd("c100"),
    [{conbee,
      [{conbee_addr,"172.17.0.2"},
       {conbee_port,80},
       {conbee_key,"D83FA13F74"}]}
    ]=config:host_application_config("c100"),
...
%% Returns: List({HostId,Ip,SshPort,Uid,Pwd}
%% --------------------------------------------------------------------
-define(SourceFile,"./tests/specs/spec.host").
